    ...
    <div className="row">
      <div className="col-4">
        <div id="list-example" className="list-group">
          <a className="list-group-item list-group-item-action" href="#list-item-1" style={{ fontFamily: 'abaddon II', fontSize: '20px' }}>1989</a>
          <a className="list-group-item list-group-item-action" href="#list-item-2" style={{ fontFamily: 'abaddon II', fontSize: '20px' }}>1990</a>
          <a className="list-group-item list-group-item-action" href="#list-item-3" style={{ fontFamily: 'abaddon II', fontSize: '20px' }}>1991</a>
          <a className="list-group-item list-group-item-action" href="#list-item-4" style={{ fontFamily: 'abaddon II', fontSize: '20px' }}>1992</a>
        </div>
      </div>
      <div className="col-8">
